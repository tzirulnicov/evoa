...
use lib '/www/evoo/evoo.ru/cmsbuilder/libcore';
use lib '/www/evoo/evoo.ru/cmsbuilder/libsite';
...
our $path_home					= '/www/evoo/evoo.ru';
...
our $mysql_dumpcmd				= '/usr/local/bin/mysqldump -u' . $mysql_user . ' -p' . $mysql_pas . ' -P' . $mysql_port . ' -Q --compatible=mysql40 --default-character-set=' . $mysql_charset . ' --add-drop-table ' . $mysql_base;
our $mysql_importcmd			=     '/usr/local/bin/mysql -u' . $mysql_user . ' -p' . $mysql_pas . ' -P' . $mysql_port . ' --default-character-set=' . $mysql_charset . ' ' . $mysql_base;
...
our @slashobj_myurl				= qw(modSite1 modSite2 modSite3 modSite4 modSite5 modSite6 modSite46);
our @slashobj_my4				= qw(modSite1 modRoot1 modTags1 modCatalog1 modSite2 modSite3 modSite4 modSite5 modSite6 modSite46        modSite47 modSite48);
